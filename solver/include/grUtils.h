...
/**
 * @brief Wrapper function for the analytical solve for EM5's initial data
 */
...
/**
 * @brief Initializes E and B fields for EM5 at a specified spatial point.
 *
 ...
 */
void initDataEM5(const double x, const double y, const double z,
              double* var);
